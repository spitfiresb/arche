 ...
 * public/demos/floorsense/ and framed as a live demo from /work/personal. The only
...
(() => {
  ...
  function renderApp() {
    ...
    if (!isEmbed) {
      ...
      tag.innerHTML = `<a class="fs-back" href="/work/personal">← Back to work</a><span>Intelligent Floorplan Analysis</span>`;
      header.append(tag);
    }
